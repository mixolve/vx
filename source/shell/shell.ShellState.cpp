...
namespace
{
const std::array<juce::Identifier, 17>& editorWindowAndVisualizerStateProperties()
{
    static const std::array<juce::Identifier, 17> properties
    {
        VxAudioProcessor::editorWidthStateKey,
        VxAudioProcessor::editorHeightStateKey,
        VxAudioProcessor::activeModuleStateKey,
        VxAudioProcessor::moduleChainStateKey,
