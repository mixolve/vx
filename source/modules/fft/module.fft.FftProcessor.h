...
public:
    ...
    struct DisplaySettings
    {
        ...
        float rangeLow = -60.0f;
        float rangeHigh = 10.0f;
        float leftThreshold = 0.0f;
        float rightThreshold = 0.0f;
        float slopePerOctave = 4.5f;
    ...
    inline static constexpr auto paramFftSizeId = "fft_fft_size";
    inline static constexpr auto paramOverlapId = "fft_overlap";
    inline static constexpr auto paramLeftId = "fft_left";
    inline static constexpr auto paramRightId = "fft_right";
    inline static constexpr auto paramRangeLowId = "fft_range_low";
    inline static constexpr auto paramRangeHighId = "fft_range_high";
    inline static constexpr auto paramSlopeId = "fft_slope";
    ...
    inline static constexpr auto paramDspHopDivisorId = "fft_dsp_hop_divisor";
    ...
    void copyPhaseAnalysisData(std::array<float, analyserScopeSize>& detectorDestination,
...
private:
    ...
    public:
        ...
        void pushPhaseBuffer(const juce::AudioBuffer<float>& buffer,
                             int numInputChannels,
                             int fftSize,
                             int overlapFactor,
                             float averagingTimeMs,
        ...
        void copyPhaseAnalysisScopes(std::array<float, analyserScopeSize>& detectorDestination,
                                     std::array<float, analyserScopeSize>& leftReductionDestination,
                                     std::array<float, analyserScopeSize>& rightReductionDestination) const;

    private:
        void generateAnalysis(int fftSize,
                              int overlapFactor,
                              float averagingTimeMs,
                              int channelsToUse) noexcept;
        void generatePhaseAnalysis(int fftSize,
                                   int overlapFactor,
                                   float averagingTimeMs) noexcept;
        void resetHistoryAndSmoothing() noexcept;
        void selectMode(bool phaseMode) noexcept;
        ...
        std::array<std::array<float, maxFftSize>, maxChannels> sampleHistory {};
        std::array<std::array<juce::dsp::Complex<float>, maxFftSize>, maxChannels> fftData {};
        std::array<std::array<float, analyserScopeSize>, 2> scopeBuffers {};
        std::array<std::array<float, analyserScopeSize>, 2> phaseDetectorScopeBuffers {};
        std::array<std::array<std::array<float, analyserScopeSize>, maxChannels>, 2> phaseReductionScopeBuffers {};
        std::array<float, analyserScopeSize> smoothedMagnitudes {};
        std::array<float, analyserScopeSize> smoothedPhaseCorrelations {};
        std::array<std::array<float, analyserScopeSize>, maxChannels> latestPhaseReductions {};
        std::array<std::array<float, analyserScopeSize>, maxChannels> smoothedPhaseReductions {};
        int historyWriteIndex = 0;
        int availableSamples = 0;
        int samplesSinceLastTransform = 0;
        int activeMode = -1;
        bool phaseAnalysisReady = false;
    ...
    public:
        ...
        void copyReductionScope(std::array<float, analyserScopeSize>& leftDestination,
                                std::array<float, analyserScopeSize>& rightDestination) const;
        float getPublishedThreshold(int channel) const noexcept;
    ...
    private:
        ...
        std::array<std::atomic<float>, maxChannels> publishedThresholdValues { 0.0f, 0.0f };
    ...
    std::atomic<float> analyserPhaseRangeLowValue { -1.0f };
    std::atomic<float> analyserPhaseRangeHighValue { 1.0f };
