...
private:
    ...
    public:
        ...
        const juce::String getName() const override { return "trs_parameter_host"; }
    ...
    trs::dsp::DspCore::Parameters readBandParameters(size_t bandIndex) const noexcept;
