...
size_t Crossover::compIndex(const size_t splitIndex, const size_t bandIndex)
{
...
Crossover::BandArray Crossover::processSample(const double leftInput, const double rightInput)
{
    BandArray bands {};
