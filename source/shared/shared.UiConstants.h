...
inline constexpr int moduleFrameInsetX = 8;
inline constexpr int moduleFrameInsetY = 4;
inline constexpr int internalFrameInsetX = 4;
inline constexpr int internalFrameInsetY = 4;
