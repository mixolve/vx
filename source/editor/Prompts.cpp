...
void EqeAudioProcessorEditor::showTextPrompt(const juce::String& currentText,
...
void EqeAudioProcessorEditor::showChoicePrompt(const juce::Rectangle<int>& anchorBounds,
...
void EqeAudioProcessorEditor::showInfoPrompt(const juce::String& markdownText)
{
    dismissTextPrompt();
...
void EqeAudioProcessorEditor::dismissTextPrompt()
{
