...
struct EqeAudioProcessorEditor::BellSection
{
    explicit BellSection(juce::AudioProcessorValueTreeState& state, int bandIndex);

    EqeAudioProcessor::FilterType getFilterType() const noexcept;
    ...
    void setStoredValues(EqeAudioProcessor::FilterType type,
                         double frequency,
                         double bandwidth,
                         double slope,
                         int lrms,
                         bool isCustom = false) noexcept;
    double getStoredFrequency(EqeAudioProcessor::FilterType type) const noexcept;
    double getStoredBandwidth(EqeAudioProcessor::FilterType type) const noexcept;
    double getStoredSlope(EqeAudioProcessor::FilterType type) const noexcept;
    int getStoredLrms(EqeAudioProcessor::FilterType type) const noexcept;
    bool isStoredValuesCustom(EqeAudioProcessor::FilterType type) const noexcept;
    void captureCurrentValuesForType(EqeAudioProcessor::FilterType type, bool markCustom = true) noexcept;
    ...
    EqeAudioProcessor::FilterType lastFilterType = EqeAudioProcessor::FilterType::bell;
