...
bool isShelfFilterType(const EqeModuleProcessor::FilterType type) noexcept
{
    return type == EqeModuleProcessor::FilterType::lowShelf
        || type == EqeModuleProcessor::FilterType::highShelf;
}

bool isCutFilterType(const EqeModuleProcessor::FilterType type) noexcept
{
    return type == EqeModuleProcessor::FilterType::lowCut
        || type == EqeModuleProcessor::FilterType::highCut;
}

bool isTiltFilterType(const EqeModuleProcessor::FilterType type) noexcept
{
...
ShelfSlopeBlend mapCutSlopeToBlend(const EqeModuleProcessor::FilterType type, const double slope) noexcept
{
    return mapDiscreteSlopeToBlend(slope,
                                   6.0,
                                   4,
                                   type == EqeModuleProcessor::FilterType::lowCut
