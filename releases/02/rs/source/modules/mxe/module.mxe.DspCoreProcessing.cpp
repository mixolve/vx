...
{
    const auto inputGain = derived.inGain * derived.autoInGain;
    const auto inputRightGain = derived.inRightGain * derived.autoInRightGain;
    const auto inputLeftGain = derived.inLeftGain * derived.autoInLeftGain;
    const auto widthGain = derived.wideAmount;
