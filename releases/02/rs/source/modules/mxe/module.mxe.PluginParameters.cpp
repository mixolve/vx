...
juce::AudioProcessorValueTreeState::ParameterLayout createParameterLayout()
{
    ...
    fullbandGroup->addChild(boolParam(makeModuleBypassParameterId(), "MXE - MISC - BYPASS", false, true));
    fullbandGroup->addChild(boolParam(makeModuleBypassWithGainParameterId(), "MXE - MISC - BYPASS.WT-GAIN", false, true));
