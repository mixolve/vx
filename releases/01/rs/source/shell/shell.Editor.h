...
private:
    ...
    void registerActiveEqeParameterListeners();
    void unregisterActiveEqeParameterListeners();
    void rebindActiveModuleEditors();
    void setupShellControls();
    void syncGlobalInGainLrControlFromParameters();
    ...
    juce::AudioProcessorValueTreeState* activeEqeValueTreeState = nullptr;
    ...
    std::unique_ptr<LocalParameterControl> globalInGainLrControl;
    ...
    std::unique_ptr<ParameterControl> speAnalyserFftSizeControl;
    std::unique_ptr<ParameterControl> speAnalyserOverlapControl;
    std::unique_ptr<ParameterControl> speAnalyserLeftControl;
    std::unique_ptr<ParameterControl> speAnalyserRightControl;
    std::unique_ptr<ParameterControl> speAnalyserRangeLowControl;
    std::unique_ptr<ParameterControl> speAnalyserRangeHighControl;
    std::unique_ptr<ParameterControl> speAnalyserSlopeControl;
    std::unique_ptr<ParameterControl> speAnalyserTimeControl;
    ...
    bool syncingGlobalInGainLrControl = false;
