...
inline constexpr int sectionComponentGap = sectionRowGap > (contentFrameInsetY * 2)
    ? sectionRowGap - (contentFrameInsetY * 2)
    : 0;
inline constexpr int monitorToSectionGap = verticalGap > contentFrameInsetY
    ? verticalGap - contentFrameInsetY
    : 0;
